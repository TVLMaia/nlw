...
const selectClassesAndProffys = await db.all(`
    ...
    // o horario que a pessoa trabalha, exemplo, é das 8 as 18
    // o horario do timefrom 8 precisa ser menor ou igual ao horario solicitado
    //o timeto precisa ser acima só
